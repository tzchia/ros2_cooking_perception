...
from segmentation.data import load_pair, select_split_df
...
def create_comparison_grid(
    ...
    plt.tight_layout()
    save_path = args.viz_out or (output_dir / f"comparison_grid_{args.viz_split}.jpg")
...
if __name__ == "__main__":
    ...
    split_df = select_split_df(df, args, args.viz_split)
